...
public class FragmentUtils {
     ...
     * It means the first fragment to show when the activity with the BottomNavigationView launches
     */
    ...
    public static void addShowHideFragment(FragmentManager fragmentManager,
        ...
        fragmentManager
                ...
                .hide(hide)
                .commit();
        if (shouldAddToStack) tagStacks.get(tag)
                .push(show.getClass().getName() + TAG_SEPARATOR + show.hashCode());
    }
    ...
    /**
     * Send action from fragment to activity, to perform some operations
     */
